#!/usr/bin/env bash
# Supervisor: runs the MASC-C audio-dialect scan (badrex mms300m) on the text-stage
...
OUT=Runs/dialect_scan_badrex_mms300m_lev08_text_candidates_masc_c_only
TEXT_PROBS=Runs/text_dialect_scan_marbertv2_written_clean_masc_c_only/row_probabilities.jsonl
